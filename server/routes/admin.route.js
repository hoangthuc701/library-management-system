...
router.post('/admin/BorrowingCard/edit/:id',borrowingCardController.update);
...
router.post('/admin/borrowingCardBook/edit/:id',borrowingCardBookController.update);
...
router.post('/admin/readerCard/edit/:id',readerCardController.update);
...
router.post('/admin/category/edit/:id',CategoryController.update);
...
router.post('/admin/returningCard/add/:id',returningCardController.add);
